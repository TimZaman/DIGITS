...
def build_model(params):
    ...
    tf.summary.image(_x.op.name, _x, max_images=5, collections=[digits.GraphKeys.SUMMARIES_VAL])
    tf.summary.image(model.op.name, model, max_images=5, collections=[digits.GraphKeys.SUMMARIES_VAL])
